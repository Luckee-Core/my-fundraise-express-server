-- Deck E — On-Prem Install: pitch deck + 9 slides (live review set)
...
WHERE pitch_deck_id = 'de000000-0000-4000-8000-000000000001'
  AND id NOT IN ('de000000-0000-4000-8000-000000000101', 'de000000-0000-4000-8000-000000000102', 'de000000-0000-4000-8000-000000000103', 'de000000-0000-4000-8000-000000000104', 'de000000-0000-4000-8000-000000000106', 'de000000-0000-4000-8000-000000000107', 'de000000-0000-4000-8000-000000000108', 'de000000-0000-4000-8000-00000000010b', 'de000000-0000-4000-8000-00000000010c');
...
const styles = {
  ...
  ('de000000-0000-4000-8000-000000000106', 'de000000-0000-4000-8000-000000000001', 'Business model', 'business_model', jsonb_build_object('tsx', $tsx_business_model$export default function Slide() {
  return (
    <div className={styles.root}>
...
const styles = {
  ...
  mark: `
    h-14 w-auto shrink-0
  `,
};$tsx_business_model$), 4, now(), now()),
  ('de000000-0000-4000-8000-000000000107', 'de000000-0000-4000-8000-000000000001', 'Go to market', 'go_to_market', jsonb_build_object('tsx', $tsx_go_to_market$export default function Slide() {
  return (
    <div className={styles.root}>
...
const styles = {
  ...
  mark: `
    h-14 w-auto shrink-0
  `,
};$tsx_go_to_market$), 5, now(), now()),
  ('de000000-0000-4000-8000-000000000108', 'de000000-0000-4000-8000-000000000001', 'Competition', 'competition', jsonb_build_object('tsx', $tsx_competition$export default function Slide() {
  return (
    <div className={styles.root}>
